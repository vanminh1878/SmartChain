    ...
    public void Configure(EntityTypeBuilder<ProductSupplier> builder)
        {
            ...
            builder.HasOne<Product>().WithMany().HasForeignKey(ps => ps.ProductId)
                .HasConstraintName("FK_ProductSupplier_Product").OnDelete(DeleteBehavior.Cascade);
            builder.HasOne<Supplier>().WithMany().HasForeignKey(ps => ps.SupplierId)
                .HasConstraintName("FK_ProductSupplier_Supplier").OnDelete(DeleteBehavior.Cascade);
        }
}